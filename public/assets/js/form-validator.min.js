! function(t) {
    ...
    var a = ':input:not([type="submit"], button):enabled:visible',
        r = function(e, a) {
            for (var i in this.$element = t(e), this.options = a, a.errors = t.extend({}, r.DEFAULTS.errors, a.errors), a.custom)
                if (!a.errors[i]) throw new Error("Missing default error message for custom validator: " + i);
            t.extend(r.VALIDATORS, a.custom), this.$element.attr("novalidate", !0), this.toggleSubmit(), this.$element.on("input.bs.validator change.bs.validator focusout.bs.validator", t.proxy(this.validateInput, this)), this.$element.on("submit.bs.validator", t.proxy(this.onSubmit, this)), this.$element.find("[data-match]").each(function() {
                var e = t(this),
                    a = e.data("match");
    ...
    r.DEFAULTS = {
        ...
        var i = [],
            o = t.Deferred(),
            n = this.options;
        return e.data("bs.validator.deferred") && e.data("bs.validator.deferred").reject(), e.data("bs.validator.deferred", o), t.each(r.VALIDATORS, t.proxy(function(t, r) {
            ...
            var r = {};
            r[e.attr("name")] = e.val(), t.get(e.data("remote"), r).fail(function(t, e, r) {
                i.push(a("remote") || r)
            }).always(function() {
                o.resolve(i)
            })
        ...
        return this.options.delay = 0, this.$element.find(a).trigger("input.bs.validator"), this.options.delay = t, this
        ...
        return !!this.$element.find(a).filter(function() {
            return !!(t(this).data("bs.validator.errors") || []).length
        }).length
    }, r.prototype.isIncomplete = function() {
        return !!this.$element.find(a).filter("[required]").filter(function() {
        ...
        return this.$element.removeAttr("novalidate").removeData("bs.validator").off(".bs.validator"), this.$element.find(a).off(".bs.validator").removeData(["bs.validator.errors", "bs.validator.deferred"]).each(function() {
            var e = t(this),
    ...
    t.fn.validator = e, t.fn.validator.Constructor = r, t.fn.validator.noConflict = function() {
